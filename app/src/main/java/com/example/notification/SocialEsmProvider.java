 ...
 */
public class SocialEsmProvider extends ContentProvider {
   ...
   // public static String DATABASE_NAME = Environment
    ...
    public boolean onCreate() {
        ...
        sUriMatcher.addURI(SocialEsmProvider.AUTHORITY, DATABASE_TABLES[0],
                ESM);
        sUriMatcher.addURI(SocialEsmProvider.AUTHORITY,
